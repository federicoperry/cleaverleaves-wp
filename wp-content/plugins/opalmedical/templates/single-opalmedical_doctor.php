			...
			<?php if ( have_posts() ) : ?>
				<div class="single-opalmedical-container">
					<?php while ( have_posts() ) : the_post(); ?>
	                    <?php echo Opalmedical_Template_Loader::get_template_part( 'content-single-doctor' ); ?>
					<?php endwhile; ?>
				</div>
				...
				<?php
					/**
					 * opalmedical_after_single_property_summary hook
					 *
					 ...
					 */
					do_action( 'opalmedical_after_single_doctor_summary' );
