...
<div class="widget-twitter block">
	<div class="block_content">
		<div id="wpopal-twitter<?php echo esc_attr( $user ); ?>" class="wpopal-twitter">
...
<script type="text/javascript">
	(function($) {
		...
		function hideTwitterBoxElements() {
		 setTimeout( function() {
		  if ( $('[id*=wpopal-twitter<?php echo esc_js( $user ); ?>]').length ) {
		   $('#wpopal-twitter<?php echo esc_js( $user ); ?> iframe').each( function(){
