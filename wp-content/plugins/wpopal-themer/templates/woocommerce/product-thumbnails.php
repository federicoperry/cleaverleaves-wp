...
$attachment_ids =  array_merge( $images, array( get_post_thumbnail_id() ) ) ;
...
if ( $attachment_ids ) {
    ...
    <div id="image-additional-carousel" class="<?php echo esc_attr($classlayout); ?>" >
         <div class="image-additional olw-carousel owl-carousel-play" id="image-additional" data-ride="owlcarousel">
             <div id="image-additional-carousel" class="owl-carousel" data-slide="<?php echo $columns; ?>" data-pagination="false" data-navigation="true" data-tablet="3"  data-mobile="3">
        ...
        <?php
            ...
            foreach ( $attachment_ids as $attachment_id ) {
                ...
                $img_size = wp_get_attachment_image_src($attachment_id , 'single');
                ...
                $image       = wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_small_thumbnail_size', 'gallery_thumbnail' ), 0, $attr = array(
                    'title' => $image_title,
                    'alt'   => $image_title,
                ...
                echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="%s"   data-image="%s" class="%s" title="%s">%s</a>', $image_link, $img_size[0], $image_class, $image_caption, $image ), $attachment_id, $post->ID, $image_class );
                $loop++;
            }
