...
class Wpopal_bootstrap_navwalker extends Walker_Nav_Menu {
   ...
   /**
    ...
    public function genMegaMenuByConfig( $item, $depth ){
        ...
        global $borsmi_megamenu; 

        $post = get_post( $item->megamenu_profile ); $borsmi_megamenu = 'true';
        $content = do_shortcode( $post->post_content ); 
        $borsmi_megamenu  = null;
