...
if( $package && isset($package->post_title) ):
...
<div class="alert alert-warning">
	<p><?php _e( 'You have not purchased any package now. If you would like to submit more your properties', 'opalmembership' ); ?></p>
	<p><a href="<?php echo opalmembership_get_membership_page_uri();?>"><?php _e( 'Please click to this link to see plans', 'opalmembership' );?></a></p>
</div>
