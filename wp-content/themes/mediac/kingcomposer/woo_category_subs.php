        ...
        <div class="inner nopadding">
                ...
                <div class="category-filter-v1">
                    <div class="category-filter-content">
                        <h4 class="category-filter-title">
                         ...
                         <small><?php echo trim($term->count); ?> <?php esc_html_e( 'Products', 'mediac' );?></small>
                        ...
                        <div class="category-filter-link">
                            <a href="<?php echo esc_url( $category_link ); ?>" title="<?php esc_html_e( 'more', 'mediac'); ?>" class=""><?php esc_html_e( '+ more...', 'mediac' ); ?></a>
                        </div>
                    </div>
            ...
            <?php } else { ?>
                <div class="category-filter-default">
                    <?php if( $image ) { ?>
                        <img class="hidden-sm hidden-md" src="<?php echo esc_url_raw( $image[0] ); ?>" title="<?php echo esc_attr($term->name); ?>" style="max-width: 100%" alt="">
                        <h4 class="name">
                            <span><?php echo trim($term->name); ?></span>
                        </h4>
                    <?php } ?>
